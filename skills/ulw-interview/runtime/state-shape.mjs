...
export function canonicalizeState(rawState) {
  ...
  return {
    ...
    topology: { ...topology, components, lastTargetedComponentId: topology.lastTargetedComponentId ?? null },
    ...
    pendingThresholdCrossingConfirmation: state.pendingThresholdCrossingConfirmation ?? false,
...
export function createInitialState(input) {
  ...
  return {
    ...
    pendingThresholdCrossingConfirmation: false,
    autoAnswerStreak: 0,
